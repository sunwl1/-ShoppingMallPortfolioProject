...
document.querySelector('.pageContainer').appendChild(imgsContainer);
...
contaierBox(imageGalleryFirst);
contaierBox(imageGallerySecond);
contaierBox(imageGalleryThird);
contaierBox(imageGalleryFourth);
contaierBox(imageGalleryFifth);
contaierBox(imageGallerySixth);
contaierBox(imageGallerySeventh);
contaierBox(imageGalleryEighth);
contaierBox(imageGalleryNinth);
contaierBox(imageGalleryTenth);
contaierBox(imageGalleryEleventh);
contaierBox(imageGalleryTwelfth);
